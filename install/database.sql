-- Datenbankname: backup_monitor2
-- Datenbankbenutzer: backup_user
-- Benutzerkennwort: bei der Installation mit der install.sh festgelegt


-- Tabelle für die eingegangenen Mails (durch die mail-to-database.py)
-- enthaelt Absendermailadresse, Datum & Uhrzeit der Mail, Betreff und den Inhalt der Mail
-- zusätzlich gibt es einen Wert, der angibt, ob die Mail bereits Verarbeitet wurde (Zuordnung zu einem Backup-Job und Ergebniss des Jobs auslesen)
